...
- 本项目仅用于技术研究、学习交流与个人合法合规使用。
- 请在遵守当地法律法规、站点服务条款与版权要求的前提下使用本工具。
- 因使用本项目造成的任何直接或间接后果（包括但不限于账号风险、数据丢失、版权争议或服务封禁），由使用者自行承担。
- 项目维护者不对第三方站点内容的可用性、完整性、合法性或持续可访问性作任何保证。
