...
func TestManualCandidateSourceHealth(t *testing.T) {
	...
	testCases := []candidateHealthCase{
		...
		{siteKey: "yodu", keyword: "斗罗", bookURL: "https://www.yodu.org/book/18862/", chapterURL: "https://www.yodu.org/book/18862/4662939.html", timeout: 2 * time.Minute},
...
func registerCandidateHealthSites(registry *Registry) {
	...
	registry.RegisterWithHosts("yodu", []string{"yodu.org"}, func(cfg config.ResolvedSiteConfig) Site {
